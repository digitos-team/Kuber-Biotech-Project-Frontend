    ...
    <div className="bg-gray-50">
      ...
      <div className="relative h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-10 max-w-2xl mx-auto animate-slideUp delay-100">
            {home.description}
          </p>
          <Link
            to="/products"
            className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg animate-bounce"
          >
            {home.viewProducts}
          </Link>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        {/* What We Offer */}
        <div className="mb-20">
          <h3 className="text-4xl font-bold text-center text-gray-800 mb-12 relative inline-block left-1/2 -translate-x-1/2">
            {home.whatWeOffer}
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="bg-green-700 p-12 text-white flex flex-col justify-center">
              <h3 className="text-4xl font-bold mb-8">{home.whyChooseUsTitle}</h3>
            ...
            <div className="p-12 flex flex-col justify-center items-center bg-gray-50 text-center">
              <h3 className="text-3xl font-bold text-gray-800 mb-6">{home.readyToStart}</h3>
              <p className="text-gray-600 mb-8 text-lg">{home.experienceQuality}</p>
              <p className="text-2xl font-bold text-green-700 mb-8 border-b-2 border-green-200 pb-2 inline-block">
                {home.callToAction}
              </p>
              <Link
                to="/contact"
